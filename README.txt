...
To try it, you will need to extract manually annotations and images Feature vectors using functions provided in the helper folder (too big to upload). You will also need to have the MS COCO database and give path to the db folder in some .py files.
